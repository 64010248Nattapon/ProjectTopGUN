...
#Get data by station_id
@router.get("/station/{id}", response_description="Waters retrieved")
async def get_waters_by_station_id(id):
    waters = await retrieve_waters_by_station_id(id)
    if waters:
